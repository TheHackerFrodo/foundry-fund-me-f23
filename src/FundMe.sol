...
contract FundMe {
    ...
    /// @notice Constructor to set the price feed address
    ...
    /// @dev Uses PriceConverter library to get the conversion rate
    ...
    /// @notice Function to withdraw all funds
    ...
    /// @notice Gets the amount funded by an address
    ...
    /// @notice Gets the funder by index
